...
Line 122:24 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
...
(function(algolia) {
  ...
  algolia.helpers = {
    ...
    fullHTMLTitle: function fullHTMLTitle() {
      ...
      // if we have a `smallflower.product_title` metafield, use it instead
      if ( this._highlightResult.meta && this._highlightResult.meta.smallflower && this._highlightResult.meta.smallflower.product_title ) {
        res = this._highlightResult.meta.smallflower.product_title.value;
      }
